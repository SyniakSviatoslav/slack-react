...
class Messages extends React.Component {
    ...
    handleStar = () => {
        this.setState(prevState => ({
            isChannelStarred: !prevState.isChannnelStarred
        }), () => this.starChannel());
    };
    ...
    render() {
        ...
        privateChannel, isChannnelStarred} = this.state;
        return (
            <React.Fragment>
                <MessagesHeader
                ...
                isChannnelStarred={isChannnelStarred}
                />
